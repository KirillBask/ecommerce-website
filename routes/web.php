...
Route::group(['prefix' => 'colors'], function() {
    ...
    Route::get('/', \App\Http\Controllers\Color\StoreController::class)->name('color.store');
    ...
    Route::get('/{color}', \App\Http\Controllers\Color\UpdateController::class)->name('color.update');
    Route::get('/{color}', \App\Http\Controllers\Color\DeleteController::class)->name('color.delete');
});
...
Route::group(['prefix' => 'tags'], function() {
    ...
    Route::get('/', \App\Http\Controllers\Tag\StoreController::class)->name('tag.store');
    ...
    Route::get('/{tag}', \App\Http\Controllers\Tag\UpdateController::class)->name('tag.update');
    Route::get('/{tag}', \App\Http\Controllers\Tag\DeleteController::class)->name('tag.delete');
});
